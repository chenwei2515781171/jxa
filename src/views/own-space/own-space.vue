        ...
        <Card>
            ...
            <div>
                ...
                >
                    ...
                    <FormItem label="班级：" >
                        <span>{{ userForm.header_class }}</span>
                    </FormItem>
                    <FormItem label="登录密码：">
...
export default {
    ...
    methods: {
        ...
        init () {
            this.userForm.name = sessionStorage.getItem('driver_name');
            this.userForm.cellphone = sessionStorage.getItem('driver_mobile');
            this.userForm.school = sessionStorage.getItem('school_name');
            this.userForm.header_class = sessionStorage.getItem('header_class');
        },
        cancelInputCodeBox () {
